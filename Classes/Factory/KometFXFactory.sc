...
KometFXFactory : AbstractKometFactory {
    ...
    *prAddSendSynthDef{
        ...
        SynthDef.new(\komet_send, {|inbus, outbus, level=1, fadeInTime=0.0, fadeOutTime=0.0, fadeInCurve=\lin, fadeOutCurve=\lin, gate=1|
    ...
    *prAddSynthDef{|kometSynthFuncDef|
        if(kometSynthFuncDef.category == \hoa && kometChannels.isAmbisonics.not, {
            ...
            var builtFunc = {|out, drywet=1.0, fadeInTime=0.0, fadeOutTime=0.0, fadeInCurve=\lin, fadeOutCurve=\lin, gate=1|
